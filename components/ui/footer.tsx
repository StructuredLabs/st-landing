...
const navigation = {
  ...
  social: [
    ...
    },
    {
      ...
      icon: () => <FaSlack className="h-5 w-5 sm:h-6 sm:w-6" />,
    },
  ],
};
...
export default function Footer() {
  return (
    <footer aria-labelledby="footer-heading" className="bg-white">
      <div className="border-t border-gray-900/10 py-4 px-6 flex flex-col items-center gap-3 sm:flex-row sm:justify-between">
        {/* First row: Company links */}
        <div className="flex flex-nowrap justify-center gap-3 overflow-x-auto text-xs sm:text-sm">
