      ...
      <div className="relative isolate">
        ...
        {/* Gradient shape */}
          <div
            ...
            className="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-[#4084f4] to-[#f4a8c4] opacity-30 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]"
          />
        </div>
