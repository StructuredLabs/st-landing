        ...
        <div className="bg-white py-24 sm:py-32" id="blog">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl text-center">
                    <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Resource Center</h2>
                        ...
                        >
                            <div className="relative w-full">
                                <img
                                    alt=""
                                    src={post.imageUrl}
                                    className={`w-full rounded-2xl aspect-[16/9] sm:aspect-[2/1] lg:aspect-[3/2] ${post.id === 0 ? 'object-contain bg-black' : 'object-cover bg-gray-100'}`}
                                />
